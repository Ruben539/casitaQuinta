          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                ...
                <a class="btn btn-outline-danger" href="../Views/agregarUsuario.php" style="border-color: #fff; color:#fff;">
            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0" id="tabla_Usuario">
                  ...
                  <tbody>
                  <?php 
                        $sql = mysqli_query($conection," SELECT u.id,u.cedula,u.nombre,u.usuario,r.descripcion 
                        FROM users u INNER JOIN roles r ON u.rol = r.id  where u.rol > 1 AND u.estatus = 1 ORDER BY  u.id DESC");
                    ...
                    <tr>
                      ...
                      <?php if ($_SESSION['rol'] == 1 || $_SESSION['rol'] == 2) {?>
                          <td>
                             <a href="../Views/modificarUsuario.php?id=<?php echo $data['id']; ?>"class="btn btn-outline-info" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.3), 0 6px 20px  rgba(0, 0, 0, 0.25);"><i class="fas fa-edit"></i></a>
                          </td>
                      <?php } ?>
