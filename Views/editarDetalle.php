<?php
require_once('../Controllers/modificarCantidadControllers.php');
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Cantidad</li>
          </ol>
          <h6 class="font-weight-bolder mb-0"> Editar Cantidad</h6>
        </nav>
            ...
            <div class="card h-100">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                  <h5 class="text-white text-capitalize ps-3">Editar cantidad del Servicio </h5>
                </div>
              </div>
              <div class="card-body">
