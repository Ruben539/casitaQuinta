<?php
require_once('../Controllers/modificarMontoControllers.php');
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Monto</li>
          </ol>
          <h6 class="font-weight-bolder mb-0"> Editar Monto</h6>
        </nav>
            ...
            <div class="card h-100">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                  <h5 class="text-white text-capitalize ps-3">Editar monto del Pago </h5>
                </div>
              </div>
              <div class="card-body">
                <form role="form" method="POST" action="">
                  ...
                  <div class="input-group input-group-outline mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="monto" name="monto" id="monto" required value="<?php echo $monto; ?>">
                  </div>
